...
export const metadata: Metadata = {
  ...
  description: 'La prima piattaforma AI per docenti delle scuole superiori italiane. Crea lezioni, UDA complete, verifiche ed esercizi in pochi minuti con Claude AI.',
